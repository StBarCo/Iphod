...
defmodule BibleVersions do
  ...
  def build do
    ...
    {_ok, resp} =
      try do
        HTTPoison.get(@url, [{"Accept", "application/jsonrequest"}],
          hackney: auth,
          follow_redirect: true
        )
      rescue
        _e in RuntimeError ->
          # call it `internal server error`
      ...
      case status_code do
        200 ->
          ...
          |> Enum.reduce(%{}, fn ver, acc ->
            ...
            acc |> Map.put_new(ver["abbreviation"], new_ver)
          end)
  ...
  defp get_bible_translations do
    ...
    [
      %{
        "lang_name_eng" => "Afrikaans",
        "name" => "Ou Vertaling",
        "abbreviation" => "aov",
        "source" => "getbible.net"
      },
      %{
        "lang_name_eng" => "Albanian",
        "name" => "Albanian",
        "abbreviation" => "albanian",
        "source" => "getbible.net"
      },
      %{
        "lang_name_eng" => "Amharic",
        "name" => "Haile Selassie Amharic Bible",
        "abbreviation" => "hsab",
        "source" => "getbible.net"
      },
      %{
        "lang_name_eng" => "Arabic",
        "name" => "Smith and Van Dyke",
        "abbreviation" => "arabicsv",
        "source" => "getbible.net"
      },
      %{
        "lang_name_eng" => "Bulgarian",
        "name" => "Bulgarian Bible (1940)",
        "abbreviation" => "bulgarian1940",
        "source" => "getbible.net"
      },
      ...
      %{
        "lang_name_eng" => "Esperanto",
        "name" => "Esperanto",
        "abbreviation" => "esperanto",
        "source" => "getbible.net"
      },
      %{
        "lang_name_eng" => "Estonian",
        "name" => "Estonian",
        "abbreviation" => "estonian",
        "source" => "getbible.net"
      },
      %{
        "lang_name_eng" => "Finnish",
      ...
      %{
        "lang_name_eng" => "German",
        "name" => "Luther (1912)",
        "abbreviation" => "luther1912",
        "source" => "getbible.net"
      },
      %{
        "lang_name_eng" => "Greek",
      ...
      %{
        "lang_name_eng" => "Hebrew",
        "name" => "Aleppo Codex",
        "abbreviation" => "aleppo",
        "source" => "getbible.net"
      },
      %{
        "lang_name_eng" => "Hungarian",
        "name" => "Hungarian Karoli",
        "abbreviation" => "karoli",
        "source" => "getbible.net"
      },
      %{
        "lang_name_eng" => "Italian",
        "name" => "Giovanni Diodati Bible (1649)",
        "abbreviation" => "giovanni",
        "source" => "getbible.net"
      },
      %{
        "lang_name_eng" => "Korean",
        "name" => "Korean",
        "abbreviation" => "korean",
        "source" => "getbible.net"
      },
      %{
        "lang_name_eng" => "Norwegian",
        "name" => "Bibelselskap (1930)",
      ...
      %{
        "lang_name_eng" => "Russian",
        "name" => "Synodal Translation (1876)",
      ...
      %{
        "lang_name_eng" => "Swahili",
        "name" => "Swahili",
        "abbreviation" => "swahili",
        "source" => "getbible.net"
      },
      %{
        "lang_name_eng" => "Swedish",
        "name" => "Swedish (1917)",
        "abbreviation" => "swedish",
        "source" => "getbible.net"
      },
      %{
        "lang_name_eng" => "Turkish",
        "name" => "Turkish",
        "abbreviation" => "turkish",
        "source" => "getbible.net"
      },
      %{
        "lang_name_eng" => "Vietnamese",
        "name" => "Vietnamese (1934)",
