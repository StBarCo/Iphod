...
defmodule IphodWeb.ResourcesController do
  ...
  def create(conn, %{"resources" => resources_params}) do
    ...
    case Repo.insert(changeset) do
      {:ok, resources} ->
        ...
        |> redirect(to: Routes.resources_path(conn, :index))
  ...
  def update(conn, %{"id" => id, "resources" => resources_params}) do
    ...
    case Repo.update(changeset) do
      {:ok, resources} ->
        ...
        |> redirect(to: Routes.resources_path(conn, :show, resources))
  ...
  def send(conn, %{"filename" => basename}) do
    ...
    |> put_resp_header(
      "content-disposition",
      ~s(attachment; filename="#{filename |> Path.basename()}")
    )
