...
defmodule Psalms do
  ...
  # ESV comes ready to go
  def _to_html(ps, "ESV"), do: ps
  def _to_html(ps, "BCP"), do: _to_local_html(ps)
  def _to_html(ps, "Coverdale"), do: _to_local_html(ps)
  def _to_html(ps, "COVERDALE"), do: _to_local_html(ps)
  # BibleComText comes ready to go
  def _to_html(ps, _ver), do: ps
  ...
  def build do
    %{
      day: %{
        ...
        31 => %{
          mp: [120, 121, 122, 123, 124, 125, 126, 127],
          ep: [128, 129, 130, 130, 132, 133, 134]
        }
      },
