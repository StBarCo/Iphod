defmodule RequestParser do
  ...
  def chapter_vss([chapter, ":", first, "-", last, _letters]),
    do: ref_to_tup(chapter, first, last)

  # n.b. in the case of returning a list, the order MUST be refereced
  def chapter_vss([chap1, ":", first, "-", chap2, ":", last]) do
    [ref_to_tup(chap2, 1, last), ref_to_tup(chap1, first, 999)]
  end
  ...
  def ref_to_tup(chap, v1, v2),
    do: {String.to_integer(chap), String.to_integer(v1), String.to_integer(v2)}
